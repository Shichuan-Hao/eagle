...
public class BrokerConstants {
    ...
    public static final Integer DEFAULT_REFRESH_MQ_TOPIC_TIME_STEP = 1;
    public static final Integer START_OFFSET = 0;


    public static final String TEST_PATH = "E:\\bytewalk\\jproject\\eaglemq\\eaglemq\\broker\\store\\order_cancel_topic\\00000000";
}
